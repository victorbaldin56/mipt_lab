...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
            Касательная & $L$, кДж/К & $\Delta L$, кДж/К & $\varepsilon_L$, \% \\ \hline
            Нижняя & 44.0 & 1.1 & 2.5 \\ \hline
            Верхняя & 43.4 & 1.1 & 2.5\\ \hline
        \end{tabular}
    \end{table}

        Усредняя результаты по 2-м касательным, получим:
        $$
        L = (43.7\pm 1.4)\ \text{кДж} / \text{моль},\ \varepsilon = 3.2\%
        $$
        ...
        $$
        \frac{d(\ln P)}{d(1/T)} = (-5.3 \pm 0.1)\cdot 10^3\ \text{K}, \ \varepsilon = 1.9\%
        $$
        ...
        $$
        L = (44.0 \pm 0.8)\ \text{кДж} / \text{моль},\ \varepsilon = 1.9\%
        $$

    \end{enumerate}
   \section{Вывод}
    \par Полученные нами разными методами значения теплты испарения $L$ лежат
    ...
    качественным.
    \par Из двух методов аппроксимации: линеаризации и метода
    касательных, существенно точнее оказался метод линеаризации ($\varepsilon_2 /
    \varepsilon_1 = 2$).
\end{document}
